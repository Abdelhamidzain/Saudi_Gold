...
export const metadata = {
  ...
  description: `سعر الذهب اليوم في السعودية بالريال السعودي تحديث فوري ✓ اسعار جرام الذهب عيار 21 و 24 و 22 و 18 مع سعر بيع الذهب المستعمل وأسعار سبائك الذهب وحاسبة الذهب`,
  keywords: [
        ...
        <section className="hero" id="prices">
          <div className="container">
            ...
            <p className="hero-subtitle">
              اسعار الذهب اليوم في السعودية بالريال السعودي لجميع العيارات ٢١ و ٢٤ و ٢٢ و ١٨ — تحديث فوري مع اسعار سبائك الذهب وسعر بيع الذهب المستعمل
            </p>
        ...
        <section className="section">
          <div className="container">
            <div className="info-section">
              <h2>اسعار الذهب في السعودية اليوم — لحظة بلحظة بالريال السعودي</h2>
              <p>
                سعر الذهب اليوم في السعودية يمر بفترة تقلّبات حادة. من واقع رصدنا اليومي خلال الأشهر الأخيرة — الجرام تأرجح بين الصعود والهبوط بمعدّل 8-15 ريال يومياً، وهذا يعني أن مَن يشتري عيار 21 وزن 30 جرام (شبكة عروس متوسطة مثلاً) قد يوفّر أو يدفع فرق يتجاوز 450 ريال بين يوم وآخر. هذا بالضبط السبب اللي يخلّي متابعة اسعار الذهب في السعودية أمر ضروري قبل أي عملية شراء.
              </p>
              <p>
                آلية تحديد سعر الذهب بالريال السعودي تمر بثلاث خطوات: أولاً، تُغلق بورصة لندن ونيويورك على سعر معيّن للأونصة بالدولار. ثانياً، يُقسم سعر الأونصة على 31.1035 (وزن الأونصة بالجرام) للحصول على سعر جرام الذهب الخالص عيار 24. ثالثاً، يُضرب الناتج في سعر صرف الدولار مقابل الريال (ثابت عند 3.75). النتيجة هي سعر جرام الذهب في السعودية بالريال — وهو ما نعرضه في الجدول أعلاه مع هامش تجاري بسيط لا يتجاوز 2%.
              </p>
              <p>
                ملاحظة مهمة: الأسعار المعروضة هنا هي أسعار الذهب الخام (سبوت) وليست اسعار الذهب في محلات الصاغة. المحلات تضيف <Link href="/workmanship" className="text-gold">رسوم المصنعية</Link> وضريبة القيمة المضافة 15% — وبالتالي السعر النهائي في المحل يكون أعلى بمبلغ يتراوح بين 20 إلى 70 ريال لكل جرام حسب درجة تعقيد التصميم.
              </p>
            </div>
          </div>
        </section>
