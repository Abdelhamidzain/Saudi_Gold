      ...
      <main className="container">
        ...
        <article className="article-content">
          ...
          <div className="article-body">
            ...
            <p>الخطوة 1: حدد وزن الذهب الذي تملكه بالجرام. الخطوة 2: حوّله لذهب خالص (اضرب في نسبة النقاوة). مثال: 100 جرام عيار 21 = 100 × 0.875 = 87.5 جرام ذهب خالص. الخطوة 3: قارن بالنصاب (85 جرام). في مثالنا 87.5 أكبر من 85 فتجب الزكاة. الخطوة 4: احسب 2.5% من القيمة الإجمالية. الخطوة 5: استخدم حاسبة الزكاة على موقعنا للحساب التلقائي.</p>
